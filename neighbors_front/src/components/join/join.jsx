    ...
    return(
        <div className={styles.container}>
            <form className={styles.loginForm}>
                ...
                <input ref={emailRef} type="email" className={styles.input} name="email" placeholder="이메일"/>
                <input ref={password1Ref} type="password" className={styles.input} placeholder="비밀번호"/>
                <input ref={password2Ref} type="password" className={styles.input} placeholder="비밀번호 확인"/>
                ...
                <input ref={telRef} type="number" className={styles.input} placeholder="전화번호"/>
